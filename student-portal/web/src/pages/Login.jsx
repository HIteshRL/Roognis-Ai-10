...
function validate(form, mode) {
  ...
  if (form.role !== 'student') return 'This workspace only supports student accounts.'
    ...
    <div className="login-screen">
      ...
      <section className="login-form-panel" aria-labelledby="login-title">
        <div className="login-form-inner">
          <p className="ui-eyebrow">Your learning workspace</p>
          <h2 id="login-title">{mode === 'signin' ? 'Welcome back' : 'Create your account'}</h2>
          <p className="muted login-form-copy">
            {mode === 'signin' ? 'Sign in with the email and password connected to your school.' : 'Set up a student or guardian account in a few clear steps.'}
          </p>
